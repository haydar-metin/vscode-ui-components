 ...
 */
export interface CDTTreeResourceConverter<TResource extends CDTTreeItemResource, TContextResource extends CDTTreeItemResource = TResource> {
    canHandle(resource: TResource): boolean;

    convert(resource: TResource, context: CDTTreeConverterContext<TContextResource>): CDTTreeItem<TResource>;
}
